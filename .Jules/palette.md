...
## 2024-05-14 - Tooltips for Mixer Console Buttons
**Learning:** Added dynamic tooltips to icon-only buttons for mute and solo to provide screen readers context in Flutter applications.
**Action:** Always verify `IconButton` usage, particularly in dense component layouts like mixer consoles, to ensure accessibility.
