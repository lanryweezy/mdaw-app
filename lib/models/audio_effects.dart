    ...
    for (int i = 0; i < input.length; i++) {
      ...
      if (absSample > thresholdLinear) {
        ...
        final compressedSample =
            thresholdLinear + (absSample - thresholdLinear) / ratio;
...
class EffectPresetCollection {
  static List<EffectPreset> get vocalPresets => [
    EffectPreset(
      ...
      effectParameters: {
        'eq': {'low_gain': 0.0, 'mid_gain': 2.0, 'high_gain': 3.0},
        'compressor': {
          'threshold': -25.0,
          'ratio': 3.0,
          'attack': 5.0,
    ...
    EffectPreset(
      ...
      effectParameters: {
        'eq': {'low_gain': 1.0, 'mid_gain': 0.0, 'high_gain': 2.0},
        'compressor': {
          'threshold': -20.0,
          'ratio': 2.5,
          'attack': 15.0,
    ...
    EffectPreset(
      ...
      effectParameters: {
        'eq': {'low_gain': 2.0, 'mid_gain': 1.0, 'high_gain': 4.0},
        'compressor': {
          'threshold': -15.0,
          'ratio': 5.0,
          'attack': 2.0,
  ...
  static List<EffectPreset> get mixPresets => [
    EffectPreset(
      ...
      effectParameters: {
        'eq': {'low_gain': 1.0, 'mid_gain': 0.0, 'high_gain': 1.0},
        'compressor': {
          'threshold': -15.0,
          'ratio': 4.0,
          'attack': 5.0,
    ...
    EffectPreset(
      ...
      effectParameters: {
        'eq': {'low_gain': 2.0, 'mid_gain': -1.0, 'high_gain': -1.0},
        'compressor': {
          'threshold': -20.0,
          'ratio': 3.0,
          'attack': 20.0,
