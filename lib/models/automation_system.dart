...
class AutomationSystem {
  ...
  void recordValue({
    ...
    // ⚡ Bolt: Replaced double iteration (firstWhere + contains) with a single indexWhere
    // This avoids closure allocations and O(N) contains checks in a very hot path
    final laneIndex = lanes.indexWhere((l) => l.id == laneId);

    late AutomationLane lane;
    if (laneIndex >= 0) {
